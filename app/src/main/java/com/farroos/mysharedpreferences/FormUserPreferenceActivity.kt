package com.farroos.mysharedpreferences
...
import com.farroos.mysharedpreferences.databinding.ActivityFormUserPreferenceBinding
import com.farroos.mysharedpreferences.parcelable.UserModel
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        ...
        private const val FIELD_DIGIT_ONLY = "Hanya boleh terisi dengan numerik"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var formType = intent.getIntExtra(EXTRA_TYPE_FORM, 0)
